...
.content-wrapper {
  ...
  gap: 2rem;
  align-items: center;
  margin-bottom: -8%; // Trek de hele content wrapper omhoog
}
...
.mockup-glow {
  ...
  width: 80%;
  height: 80%;
  background: radial-gradient(circle, var(--color-primary-border) 0%, transparent 40%);
  filter: blur(60px);
  pointer-events: none;
  z-index: 0;
}
...
.laptop {
  ...
  &:hover {
    ...
    filter: drop-shadow(0 25px 80px var(--color-primary-glow));
  }
}
