<template>
  <BackgroundWeb>
    <div class="contactformuliermain">
      <contact-component />
    </div>
  </BackgroundWeb>
</template>
...
const contactFaqs = [
  {
    question: 'Hoe snel krijg ik een reactie na het sturen van een bericht?',
    answer:
      'We reageren doorgaans binnen 1 werkdag op contactaanvragen. Voor dringende vragen kun je ook bellen of een korte omschrijving meesturen zodat we gericht kunnen antwoorden.',
  },
  {
    question: 'Is een kennismakingsgesprek gratis?',
    answer:
      'Ja, een eerste kennismakingsgesprek is volledig gratis en vrijblijvend. We bespreken je wensen, doelen en wat de beste aanpak is voor jouw project.',
  },
  {
    question: 'Werken jullie ook buiten Hasselt en Limburg?',
    answer:
      'Absoluut. Hoewel onze focus op Hasselt en Limburg ligt, helpen we KMO en zelfstandigen in heel Vlaanderen en de rest van Belgie. Veel trajecten verlopen volledig online.',
  },
  {
    question: 'Wat heb ik nodig voor een eerste gesprek?',
    answer:
      'Niets speciaals. Een idee van wat je wil, wie je doelgroep is en eventueel een voorbeeld van websites die je aanspreekt is al meer dan genoeg om een goed gesprek te hebben.',
  },
]
  ...
  meta: [
    {
      name: 'description',
      content:
        'Plan een gratis kennismakingsgesprek voor je AI-project of website. Snel antwoord, helder advies. Actief in Hasselt, Limburg en heel Belgie.',
    },
    {
      name: 'robots',
    ...
    { name: 'twitter:title', content: 'Contact Opnemen | JukeCoding Hasselt' },
    {
      ...
      content:
        'Plan een gratis kennismakingsgesprek voor je AI-project of website. Actief in Hasselt, Limburg en heel Belgie.',
    },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        inLanguage: 'nl-BE',
        isPartOf: { '@id': 'https://jukecoding.be/#website' },
        breadcrumb: {
          '@type': 'BreadcrumbList',
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://jukecoding.be/' },
            {
              ...
              position: 2,
              name: 'Contact',
              item: 'https://jukecoding.be/contact',
            },
          ],
        },
      }),
